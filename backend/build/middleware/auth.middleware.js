...
var authenticateRoute = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                decoded = (0, utils_1.verifyToken)(token);
                if (!decoded)
                    throw new Error("Invalid token");
                return [4 /*yield*/, user_model_1.default.findById(decoded).select("-password")];
            case 1:
                user = _a.sent();
                req.user = user;
                next();
